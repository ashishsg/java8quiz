...
public class QuizDataProvider {
	...
	static {
		List<Match> team1Matches = Arrays.asList(
				new Match(TEAM2, 150, 120, 148, 120, Ground.GAHUNJE, 1, MATCH1_DATE, TEAM1),
				new Match(TEAM3, 111, 98, 113, 68, Ground.GAHUNJE, 3, MATCH3_DATE, TEAM1),
				new Match(TEAM4, 190, 120, 168, 120, Ground.EDENGARDENS, 4, MATCH4_DATE, TEAM1));

		List<Match> team2Matches = Arrays.asList(
				new Match(TEAM1, 148, 120, 150, 120, Ground.GAHUNJE, 1, MATCH1_DATE, TEAM2),
				new Match(TEAM3, 200, 120, 197, 120, Ground.CHINNASWAMI, 2, MATCH2_DATE, TEAM2),
				new Match(TEAM4, 95, 111, 88, 99, Ground.CHINNASWAMI, 5, MATCH5_DATE, TEAM2));

		List<Match> team3Matches = Arrays.asList(
				new Match(TEAM1, 113, 68, 111, 98, Ground.GAHUNJE, 3, MATCH3_DATE, TEAM3),
				new Match(TEAM2, 197, 120, 200, 120, Ground.CHINNASWAMI, 2, MATCH2_DATE, TEAM3),
				new Match(TEAM4, 208, 120, 210, 119, Ground.WANKHEDE, 6, MATCH6_DATE, TEAM3));

		List<Match> team4Matches = Arrays.asList(
				new Match(TEAM1, 168, 120, 190, 120, Ground.EDENGARDENS, 4, MATCH4_DATE, TEAM4),
				new Match(TEAM2, 88, 99, 95, 111, Ground.CHINNASWAMI, 5, MATCH5_DATE, TEAM4),
				new Match(TEAM3, 210, 119, 208, 120, Ground.WANKHEDE, 6, MATCH6_DATE, TEAM4));
